...
describe('noteNumber from noteLetter', () => {
  const noteB = NoteOne.noteLetterToNoteNumber('B')
  const noteCs = NoteOne.noteLetterToNoteNumber('CS')
